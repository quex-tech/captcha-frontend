import{v as $,F as _,G as R,i as f,r as m,a as b,x as l,O as a,j as O}from"./index-mGlNy0m-.js";import{n as j,c as w,o as P,r as y}from"./if-defined-Bj-MS4yb.js";import{e as T,n as U}from"./ref-Dsmkfgh9.js";import{R as B}from"./ConstantsUtil-Dmg8YACJ.js";const u=$({isLegalCheckboxChecked:!1}),g={state:u,subscribe(n){return R(u,()=>n(u))},subscribeKey(n,e){return _(u,n,e)},setIsLegalCheckboxChecked(n){u.isLegalCheckboxChecked=n}},E=f`
  label {
    display: flex;
    align-items: center;
    cursor: pointer;
